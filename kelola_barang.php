...
<form action="tambah_barang.php" method="post">
    ...
    <button type="tambah_barang" name="tambah_barang" class="btn btn-primary">Tambah Barang</button>
    </div>
</form>
...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <td><a href="delete.php?id=<?php echo $data['idbarang'];?>"><button>Hapus</button></a></td>
           </tr>
       </tbody>  
    <?php 
    }
