    ...
    <div class="container2">
      <nav class="navbar navbar-default">
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
              ...
              if($user == '' && $pass ==''){
                ?>
                <div class="alert alert-warning"><b>Warning!</b>Isi Kolom Username & password!</div>
                <?php
              }
              else{
                include "koneksi.php";
                ...
                if($jml > 0){
                  ...
                  ?>
                  <div class="alert alert-warning"><b>Error!</b>Username atau Password Salah!</div>
                  <?php
                }
              }
            }
     ...
     <div class="col-md-4 col-md-offset-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-heading">
          <h5 class="panel-tittle"><span class="glyphicon glyphicon-lock"></span> Form Pendaftaran</h5>
        </div>
